...
export default async function PipelineMarketingPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-brand-bg">
      ...
      <div className="container mx-auto max-w-3xl px-4 py-20">
        <h1 className="font-heading text-4xl font-bold text-brand-text-main mb-6">{t('pages.pipeline.title')}</h1>
        <p className="text-lg text-brand-text-muted leading-relaxed mb-10">{t('pages.pipeline.body')}</p>
